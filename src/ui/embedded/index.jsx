...
// import appIcon from '../../res/icons/49.png';
...
import { h, render } from "../common/dom";
...
function App() {
  ...
  return (
    <div id="app-container" className="container">
      <input type="text" value={state.value} onInput={(e) => {

        state.value = e.target.value;
        render(<App />, document.body);
      }} />
      <h1>Hello, {state.value}!</h1>
      <Button onClick={() => console.debug(state.value)} />
    </div>
  );
}
